...
<body>
    ...
    <div class="video-background fullscreen">
        <video autoplay muted loop id="bg-video" class="bg-video">
            <source src="/public/video/856399-hd_1920_1080_25fps.mp4" type="video/mp4">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="image-gallery">
                    <img src="/public/images/pexels-ash-craig-122861-376464.jpg" class="img-fluid" alt="Gallery Image 1">
                    <img src="/public/images/pexels-evonics-1058277.jpg" class="img-fluid" alt="Gallery Image 2">
                    <img src="/public/images/pexels-janetrangdoan-1099680.jpg" class="img-fluid" alt="Gallery Image 3">
                    <img src="/public/images/pexels-life-of-pix-67468.jpg" class="img-fluid" alt="Gallery Image 4">
                </div>
            </div>
    ...
    <div class="container my-5">
        <div class="row">
            ...
            <div class="col-12 my-3">
                <div class="video-background">
                    <video autoplay muted loop class="bg-video">
                        <source src="/public/video/register.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                    <div class="video-overlay">
            ...
            <div class="col-12 my-3">
                <div class="video-background">
                    <video autoplay muted loop class="bg-video">
                        <source src="/public/video/go to video.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                    <div class="video-overlay">
            ...
            <div class="col-12 my-3">
                <div class="video-background">
                    <video autoplay muted loop class="bg-video">
                        <source src="/public/video/eat video.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                    <div class="video-overlay">
            ...
            <div class="col-12 my-3">
                <div class="video-background">
                    <video autoplay muted loop class="bg-video">
                        <source src="/public/video/reivew video.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                    <div class="video-overlay">
