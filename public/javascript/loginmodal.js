document.addEventListener("DOMContentLoaded", function () {
    ...
    var togglePwdButton = document.getElementById("toggle_pwd");
    var submitforgotBtn = document.getElementById("forgotpwd_btn");

    if (togglePwdButton) {
        togglePwdButton.addEventListener("click", togglePassword);
    }

    if (submitforgotBtn) {
        submitforgotBtn.addEventListener("click", submitForgotPwd);
    }

    // Handle Login Modal Reset
    ...
    // Submit Forgot Password Function
